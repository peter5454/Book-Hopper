...
{
    public class ChangeInformationViewModel : ViewModelBase
    {
        ...
        public ChangeInformationViewModel(UserModel user)
        {
            User = user;
        ...
        private async void ExecuteConfirmChangesCommand(object obj)
        {
            try
            {
                ...
                if (updateSuccess)
                {
                    // Redirect to the account view with the updated user information
                    AuthService.RedirectToAccountPage(FindWindow<Window>(), User);
                }
                else
                {
        ...
        {
            // Redirect to the account view without making any changes
            AuthService.RedirectToAccountPage(FindWindow<Window>(), User);
        }
